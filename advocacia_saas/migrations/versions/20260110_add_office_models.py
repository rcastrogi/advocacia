...
def upgrade():
    ...
    op.create_table('offices',
        ...
        sa.Column('primary_color', sa.String(length=7), nullable=True, server_default='#1a73e8'),
    ...
    op.create_foreign_key('fk_offices_owner_id', 'offices', 'user', ['owner_id'], ['id'])
    
    # Adicionar colunas office_id e office_role na tabela user
    op.add_column('user', sa.Column('office_id', sa.Integer(), nullable=True))
    op.add_column('user', sa.Column('office_role', sa.String(length=20), nullable=True, server_default='lawyer'))
    ...
    op.create_table('office_invites',
        sa.Column('id', sa.Integer(), nullable=False),
        sa.Column('office_id', sa.Integer(), nullable=False),
        sa.Column('email', sa.String(length=120), nullable=False),
        sa.Column('role', sa.String(length=20), nullable=False, server_default='lawyer'),
