...
def upgrade():
    ...
    op.add_column('credit_packages', sa.Column('bonus_credits', sa.Integer(), nullable=True, server_default='0'))
    op.add_column('credit_packages', sa.Column('original_price', sa.Numeric(10, 2), nullable=True))
    op.add_column('credit_packages', sa.Column('currency', sa.String(3), nullable=True, server_default='BRL'))
    op.add_column('credit_packages', sa.Column('updated_at', sa.DateTime(), nullable=True))
