...
def upgrade():
    ...
    op.create_index('ix_table_preferences_user_view', 'table_preferences', ['user_id', 'view_key'], unique=False)
    op.create_unique_constraint('uq_user_view', 'table_preferences', ['user_id', 'view_key'])
