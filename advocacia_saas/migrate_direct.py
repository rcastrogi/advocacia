...
def main():
    ...
    print("\n🔨 Criando tabelas...")
    import os
    os.environ['DATABASE_URL'] = f"postgresql://{SUPABASE_USER}:{quote_plus(SUPABASE_PASSWORD)}@{SUPABASE_HOST}:{SUPABASE_PORT}/{SUPABASE_DB}?sslmode=require"
    ...
    # Ordem de migração
    priority = ['user', 'billing_plans', 'petition_types', 'estados', 
