...
try:
    ...
    if login_page.status_code == 200:
        ...
        if 'dashboard' in login_response.url or login_response.status_code in [200, 302]:
            ...
            sections_response = session.get('http://127.0.0.1:5000/admin/petitions/sections', timeout=10, allow_redirects=True)
            ...
            if sections_response.status_code == 200:
                ...
                if 'Erro' in sections_response.text or 'error' in sections_response.text.lower():
