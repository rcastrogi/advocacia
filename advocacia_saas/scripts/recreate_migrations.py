...
def update_alembic_version(new_version):
    ...
    db.session.execute(db.text(f"INSERT INTO alembic_version (version_num) VALUES ('{new_version}')"))
    db.session.commit()
...
def main():
    ...
    parser.add_argument('--apply', type=str, help='Aplica nova versao no alembic_version')
    parser.add_argument('--list-tables', action='store_true', help='Lista apenas nomes das tabelas')
