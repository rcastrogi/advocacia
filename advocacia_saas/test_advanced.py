...
with app.app_context():
    ...
    print(f'✓ ProcessAutomation: {automation.name if automation else "Nenhuma automação encontrada"}')

    # Testar ProcessReport
    report = ProcessReport.query.first()
    print(f'✓ ProcessReport: {report.title if report else "Nenhum relatório encontrado"}')
