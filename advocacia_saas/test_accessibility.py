...
def check_accessibility_files():
    ...
    files = {
        "JavaScript de Acessibilidade": os.path.join(
            base_path, "app", "static", "js", "accessibility.js"
        ),
        "CSS de Acessibilidade": os.path.join(
            base_path, "app", "static", "css", "accessibility.css"
        ),
