...
class TestPaymentSystem:
    ...
    def test_get_plans_page(self, client, db_session, test_user):
        ...
        client.post(
            "/auth/login",
            data={"email": test_user.email, "password": "Test123!", "submit": "Entrar"},
        )
    ...
    def test_create_pix_payment_success(
        self, client, db_session, test_user, pay_per_use_plan
    ):
        ...
        with patch("app.payments.routes.mp_sdk") as mock_mp:
            ...
            response = client.post(
                ...
                json={"plan_slug": "plano-basico", "billing_period": "1m"},
            )
    ...
    def test_create_pix_payment_invalid_plan(self, client, db_session, test_user):
        ...
        response = client.post(
            "/payments/create-pix-payment",
            json={"plan_slug": "plano-inexistente", "billing_period": "1m"},
        )
    ...
    def test_create_subscription_success(
        self, client, db_session, test_user, monthly_plan
    ):
        ...
        with patch("app.payments.routes.mp_sdk") as mock_mp:
            ...
            response = client.post(
                ...
                json={"plan_slug": "plano-mensal", "billing_period": "1m"},
            )
    ...
    def test_subscribe_page_invalid_period(
        self, client, db_session, test_user, pay_per_use_plan
    ):
    ...
    def test_duplicate_subscription_blocked(
        self, client, db_session, test_user, monthly_plan
    ):
