    ...
    try:
        ...
        with app.app_context():
            ...
            for plan_data in backup_data.get('billing_plans', []):
                ...
                plan.slug = plan_data.get('slug', plan_data['name'].lower().replace(' ', '-'))
...
if __name__ == '__main__':
    if len(sys.argv) < 2:
        ...
        print("Exemplo: python reset_and_restore_render.py backup_render_complete_20260103_020213.json --force")
        sys.exit(1)
