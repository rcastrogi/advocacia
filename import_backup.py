...
def import_roadmap_items(data):
    ...
    for item_data in data:
        ...
        item = RoadmapItem(
            ...
            planned_completion_date=parse_datetime(item_data['planned_completion_date']),
...
def import_ai_generations(data):
    ...
    for gen_data in data:
        ...
        generation = AIGeneration(
            ...
            cost_usd=Decimal(str(gen_data['cost_usd'])) if gen_data.get('cost_usd') else None,
...
def main():
    parser = argparse.ArgumentParser(description='Importar backup do Render para SQLite local')
    ...
    with app.app_context():
        try:
            ...
            print("🔄 Execute 'flask db upgrade' se necessário para sincronizar migrações.")
